...
public class DashBoard extends JFrame{
    ...
    public DashBoard(String username) {
        super("Travel and Tourism  System");
	...
	NewLabel.setBounds(0, 0, 1950, 1000); 
        ...
        JLabel l1 = new JLabel("Travel and Tourism System");
	l1.setForeground(Color.WHITE);
        l1.setFont(new Font("Tahoma", Font.BOLD, 55));
	l1.setBounds(340, 70, 1000, 100);
	NewLabel.add(l1);
	...
	menuBar.add(m5);
        ...
        JMenuItem mi12 = new JMenuItem("PAY USING UPIPayment");
	m5.add(mi12);
